          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <a href="/" class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700">Home</a>

                <a href="/lilengine-demo/basic-page/demo-page#sequence-subtitle" class="px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-900">Demo page</a>
              </div>
            </div>
          </div>
